...
pandora::StatusCode PandoraPFANewProcessor::RegisterUserComponents() const
{
    ...
    PANDORA_RETURN_RESULT_IF(pandora::STATUS_CODE_SUCCESS, !=, FineGranularityContent::RegisterAll(*m_pPandora));

    PANDORA_RETURN_RESULT_IF(pandora::STATUS_CODE_SUCCESS, !=, KMeansContent::RegisterAll(*m_pPandora));
...
void PandoraPFANewProcessor::ProcessSteeringFile()
{
    ...
    registerProcessorParameter("AverageRadiationLengthCoil",
                            ...
                            float(0.011240f)); // ILD_00, CLIC_ILD_01, CLIC_CDR value
    ...
    registerProcessorParameter("AverageRadiationLengthHCalEndCap",
                            ...
                            float(0.17392)); // CLIC_ILD_01 value. ILD_00 value is 0.043549, CLIC_CDR value is 0.035448
    ...
    registerProcessorParameter("AverageRadiationLengthMuonBarrel",
                            ...
                            float(0.047512)); // ILD_00, CLIC_ILD_01, CLIC_CDR value
    ...
    registerProcessorParameter("AverageInteractionLengthCoil",
                            ...
                            float(0.0025189f)); // ILD_00, CLIC_ILD_01, CLIC_CDR value
    ...
    registerProcessorParameter("AverageInteractionLengthHCalEndCap",
                            ...
                            float(0.0066047)); // CLIC_ILD_01 value. ILD_00 value is 0.0048187, CLIC_CDR value is 0.0041251
    ...
    registerProcessorParameter("AverageInteractionLengthMuonBarrel",
                            ...
                            float(0.0051580)); // ILD_00, CLIC_ILD_01, CLIC_CDR value
